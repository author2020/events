    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_status', models.CharField(choices=[('on_time', 'По расписанию'), ('sheduled', 'Запланировано'), ('cancelled', 'Отменено')], max_length=20, verbose_name='Статус мероприятия')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subevent', models.ManyToManyField(related_name='speakers', to='events.subevent', verbose_name='Часть программы, в которой участвует спикер')),
            ],
            options={
                'verbose_name': 'Спикер',
